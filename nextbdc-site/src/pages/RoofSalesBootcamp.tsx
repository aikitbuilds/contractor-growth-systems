            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-5xl mx-auto">
              ...
              <div className="bg-gray-50 p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow">
                ...
                <div className="flex mb-3">
                  <Star className="h-5 w-5 text-yellow-500" /> <Star className="h-5 w-5 text-yellow-500" /> <Star className="h-5 w-5 text-yellow-500" /> <Star className="h-5 w-5 text-yellow-500" /> <Star className="h-5 w-5 text-yellow-500" />
                </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-5xl mx-auto">
              ...
              <div className="bg-white p-6 rounded-lg shadow-md border-l-4 border-primary">
                 <p className="text-gray-700 italic mb-4">
                   "Steve possesses a unique ability to organize, unite, and scale sales teams. He implements improved communication, builds robust systems, and simplifies processes, while also acting as a 'sales ambassador' who fosters crucial cooperation across departments."
                 </p>
                 <div className="flex items-center">
                   ...
                   <div>
                     <p className="font-bold text-gray-900">Tyler Headley</p>
                     <p className="text-sm text-gray-600">President IES</p>
                   </div>
                 </div>
              </div>
              {/* Testimonial 2 */}
