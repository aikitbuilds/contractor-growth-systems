...
$sourceDir = ".\dist"
$zipFile = ".\bdc-main-site-build.zip"
...
if (Test-Path $zipFile) {
    ...
    Write-Host "Upload this zip file to your Namecheap hosting via the cPanel File Manager and extract it to the appropriate directory."
} else {
